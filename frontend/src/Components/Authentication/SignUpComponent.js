      ...
      <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div class="mt-12 flex flex-col items-center">
            ...
            <p class="text-center text-[20px] text-[#007F73] font-semibold pt-[20px]">
            ...
            <div class="w-full flex-1 mt-8">
              ...
              <div class="mx-auto max-w-xs">
                ...
                <p class="text-center text-sm text-gray-500 pt-[20px]">
                  Are you a vendor?&nbsp;
                  <a
                    href="#!"
                    class="font-semibold text-[#007F73] hover:underline focus:text-gray-800 focus:outline-none"
                  >
                    Business Sign up
                  </a>
                  .
