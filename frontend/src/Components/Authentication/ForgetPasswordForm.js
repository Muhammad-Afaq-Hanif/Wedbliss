...
import { ForgetPasswordContext } from "../../Providers/Authentication/ForgetPasswordProvider";

const ForgetPasswordForm = function () {
  const { email, setEmail, setFetchData } = useContext(ForgetPasswordContext);
  return (
    <form
      onSubmit={(event) => {
    ...
    >
      ...
      >
        ...
        <span class="ml-3">Request Reset Link</span>
      </button>
    </form>
  );
};
