...
const Admin = require(`./../../models/Users/adminSchema.js`);
//Sign Up Functionality Admin Creation
...
exports.forgetPassword = async function (req, resp, next) {
  try {
    ...
    //Admin Enter email or not
    if (!email) throw new Error("Please Enter Email Address");
    //Admin Still Exist OR NOT(Deleted)
    const user = await Admin.findOne({ email });
    if (!user) throw new Error("Admin not Exist");
